...
CONFIG_FIELD_REGISTRY: List[Dict[str, str]] = [
    ...
    {"path": "video.save_video", "tier": TIER_DEVELOPER, "group": "video", "label": "全局录像输出"},
    ...
    {"path": "logic.require_vehicle_type_for_events", "tier": TIER_DEVELOPER, "group": "logic", "label": "车型锁定后触发"},
    ...
    {"path": "logic.enable_global_video", "tier": TIER_DEVELOPER, "group": "logic", "label": "全局录像"},
    {"path": "logic.per_id_downscale_ratio", "tier": TIER_DEVELOPER, "group": "logic", "label": "按车 ID 降分辨率"},
    {"path": "logic.per_id_frame_stride", "tier": TIER_DEVELOPER, "group": "logic", "label": "按车 ID 帧步长"},
    {"path": "logic.per_id_auto_adapt", "tier": TIER_DEVELOPER, "group": "logic", "label": "按车 ID 自动适配"},
    {"path": "logic.per_id_auto_cpu_high", "tier": TIER_DEVELOPER, "group": "logic", "label": "自动适配高阈值"},
    {"path": "logic.per_id_auto_cpu_low", "tier": TIER_DEVELOPER, "group": "logic", "label": "自动适配低阈值"},
    {"path": "logic.per_id_max_frame_stride", "tier": TIER_DEVELOPER, "group": "logic", "label": "按车 ID 最大帧步长"},
    {"path": "logic.enable_event_disk", "tier": TIER_DEVELOPER, "group": "logic", "label": "事件落盘"},
    ...
    {"path": "storage.disk_threshold", "tier": TIER_DEVELOPER, "group": "storage", "label": "磁盘清理阈值"},
    {"path": "storage.disk_target", "tier": TIER_DEVELOPER, "group": "storage", "label": "磁盘目标阈值"},
    {"path": "storage.clean_interval_seconds", "tier": TIER_DEVELOPER, "group": "storage", "label": "清理间隔"},
    {"path": "storage.capture_keep_days", "tier": TIER_DEVELOPER, "group": "storage", "label": "截图保留天数"},
    {"path": "storage.capture_keep_count", "tier": TIER_DEVELOPER, "group": "storage", "label": "截图保留数量"},
    {"path": "storage.per_id_video_keep_days", "tier": TIER_DEVELOPER, "group": "storage", "label": "单车视频保留天数"},
    {"path": "storage.per_id_video_keep_count", "tier": TIER_DEVELOPER, "group": "storage", "label": "单车视频保留数量"},
    {"path": "event_output_dir", "tier": TIER_DEVELOPER, "group": "output", "label": "事件目录"},
    {"path": "event_capture_dir", "tier": TIER_DEVELOPER, "group": "output", "label": "事件截图目录"},
