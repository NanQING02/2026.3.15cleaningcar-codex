...
CONFIG_FIELD_REGISTRY: List[Dict[str, str]] = [
    ...
    {"path": "storage.disk_threshold", "tier": TIER_DEVELOPER, "group": "storage", "label": "磁盘清理阈值（暂未启用）"},
    {"path": "storage.disk_target", "tier": TIER_DEVELOPER, "group": "storage", "label": "磁盘目标阈值（暂未启用）"},
    {"path": "storage.clean_interval_seconds", "tier": TIER_DEVELOPER, "group": "storage", "label": "清理间隔（暂未启用）"},
    {"path": "storage.capture_keep_days", "tier": TIER_DEVELOPER, "group": "storage", "label": "截图保留天数（暂未启用）"},
    {"path": "storage.capture_keep_count", "tier": TIER_DEVELOPER, "group": "storage", "label": "截图保留数量（暂未启用）"},
    {"path": "storage.per_id_video_keep_days", "tier": TIER_DEVELOPER, "group": "storage", "label": "单车视频保留天数（暂未启用）"},
    {"path": "storage.per_id_video_keep_count", "tier": TIER_DEVELOPER, "group": "storage", "label": "单车视频保留数量（暂未启用）"},
