...
用法:
    python tools/tests/test_plate_dual_models.py --images ./images --models ./models/plate --output ./result
"""
...
def main():
    ...
    parser.add_argument('--models', type=str, default='./models/plate', help='模型目录')
